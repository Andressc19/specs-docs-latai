...
**Document:** YAML sidecar schema generated by fileKor  
...
The sidecar is a YAML file that accompanies each processed file, allowing:
...
> **Note:** Labels are NOT auto-generated by `sidecar` command.
> Labels are added ONLY via explicit `filekor labels` command.
